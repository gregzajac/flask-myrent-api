...
def test_get_agreements_no_records(client, landlord_token):
    response = client.get(
        "/api/v1/agreements", headers={"Authorization": f"Bearer {landlord_token}"}
    )
    response_data = response.get_json()
...
def test_get_agreements_landlord_token(client, sample_data):
    response = client.post(
        ...
        json={"identifier": "landlord2", "password": "haslo2"},
    )
    ...
    response = client.get(
        "/api/v1/agreements", headers={"Authorization": f"Bearer {token}"}
    )
    response_data = response.get_json()
...
def test_get_agreements_tenant_token(client, sample_data):
    response = client.post(
        "/api/v1/tenants/login", json={"identifier": "tenant2", "password": "haslo2"}
    )
    token = response.get_json()["token"]
...
def test_get_agreement_landlord_token(client, sample_data):
    response = client.post(
        "/api/v1/landlords/login",
        json={"identifier": "landlord1", "password": "haslo1"},
    )
    token = response.get_json()["token"]
    ...
    response = client.get(
        "/api/v1/agreements/1", headers={"Authorization": f"Bearer {token}"}
    )
    response_data = response.get_json()
...
def test_get_agreement_tenant_token(client, sample_data):
    response = client.post(
        "/api/v1/tenants/login", json={"identifier": "tenant1", "password": "haslo1"}
    )
    token = response.get_json()["token"]
...
def test_create_agreement(client, tenant, flat_data, agreement_data, landlord_token):
    ...
    assert (
        response_data["data"]["payment_deadline"] == agreement_data["payment_deadline"]
    )
...
def test_create_agreement_no_token(
    client, tenant, flat_data, agreement_data, landlord_token
):
    response = client.post(
        "/api/v1/flats",
        json=flat_data,
...
def test_create_agreement_tenant_token(
    client, tenant, flat_data, agreement_data, landlord_token, tenant_token
):
    response = client.post(
        "/api/v1/flats",
        json=flat_data,
...
def test_create_agreement_wrong_flat(client, sample_data, agreement_data):
    ...
    response = client.post(
        "/api/v1/flats/2/tenants/1/agreements",
        json=agreement_data,
...
def test_create_agreement_wrong_tenant(client, sample_data, agreement_data):
    ...
    response = client.post(
        "/api/v1/flats/1/tenants/2/agreements",
        json=agreement_data,
        headers={"Authorization": f"Bearer {token}"},
    )
    response_data = response.get_json()
...
def test_update_agreement(client, flat, tenant, agreement, landlord_token):
    ...
    assert (
        response_data["data"]["payment_deadline"]
        == updated_agreement["payment_deadline"]
    )
...
def test_delete_agreement(client, agreement, landlord_token):
    response = client.delete(
        "/api/v1/agreements/1", headers={"Authorization": f"Bearer {landlord_token}"}
    )
    response_data = response.get_json()
